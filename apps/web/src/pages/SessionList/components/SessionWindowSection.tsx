...
import { InsetPanel, LastInputPill, TagPill } from "@/components/ui";
...
export const SessionWindowSection = ({ group, nowMs }: SessionWindowSectionProps) => {
  ...
  return (
    <InsetPanel className="p-3 sm:p-4">
      ...
      <div className="mt-3 grid gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
